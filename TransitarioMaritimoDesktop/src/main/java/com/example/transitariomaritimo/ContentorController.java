...
// panel Inserir contentor
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<ArmazemEntity> armazens = FXCollections.observableArrayList(armazem_repo.findByIdLike(Current_Session.current_funcionario.getIdArmazem()));
        ...
        ObservableList<ArmazemEntity> armazensDesc = FXCollections.observableArrayList(armazem_repo.findByIdLike(Current_Session.current_funcionario.getIdArmazem()));
