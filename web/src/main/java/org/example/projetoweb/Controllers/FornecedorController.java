...
public class FornecedorController {
    ...
    @GetMapping("/Fornecedores/GestorComercial")
    public String listarFornecedoresGestorComercial(Model model, HttpSession session){
        List<FornecedorEntity> fornecedores = repo_fornecedor.findAll();
        List<CodPostalEntity> codPostais = repo_codPostal.findAll();
        model.addAttribute("fornecedores", fornecedores);
        model.addAttribute("codPostais", codPostais);
        ...
        return "FornecedoresGestorComercial";
    }

    @PostMapping("/Fornecedores/Inserir/GestorComercial")
    public String inserirFornecedorGestorComercial(
            @RequestParam("nome") String nome,
            @RequestParam("nif") String nif,
            @RequestParam("rua") String rua,
            @RequestParam("porta") String porta,
        ...
        return "redirect:/Fornecedores/GestorComercial";
    }

    @PostMapping("/Fornecedores/Editar/GestorComercial")
    public String editarFornecedorGestorComercial(
            @RequestParam("id") Integer id,
            @RequestParam("nome") String nome,
            @RequestParam("nif") String nif,
            @RequestParam("rua") String rua,
    ...
    @PostMapping("/Fornecedores/Remover/GestorComercial")
    public String removerFornecedorGestorComercial(@RequestParam("id") Integer id) {
        repo_fornecedor.deleteById(id);
        return "redirect:/Fornecedores/GestorComercial";
    }
}
